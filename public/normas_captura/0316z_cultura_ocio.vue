<template>
  <div>
    ...
    <div class="picture">
      <img src="../img/0316z_cultura_ocio.png" />
      <p>
        <i
          >Área recreativa Monterrequejo. En este caso se puede apreciar el
          cerramiento (alambrada) que delimita la zona de cultura - ocio.</i
        >
      </p>
    </div>
