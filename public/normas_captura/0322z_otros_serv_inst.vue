<template>
  <div>
    ...
    <p>
      En su interior se ubican las entidades (naves, edificios, estanques,
      depósitos, etc.) estas siguen las normas de captura específicas definidas
      para ellas.
    </p>
    ...
    <p>
      ...
      han desaparecido, a excepción de entidades con carácter histórico.
    </p>
    <h3>Ejemplo de captura</h3>
    <div class="picture">
      <i>
        <img src="../img/0322z_otros_serv_inst_1.png" />
        <p>
          Ejemplo de captura para un observatorio espacial (Gran Telescopio de
          Canarias)
        </p>
      </i>
    </div>
