...
<ul>
	...
	<li><strong>En zona de pendiente acusada o fuerte pendiente</strong> <i>(pendiente superior al 6 %)</i>, si el área es menor al área mínima, su representación se realiza a través de un punto acotado.</li>
	<li><strong>En zona costera o con pendiente suave o muy llana</strong> <i>(pendiente inferior al 6%)</i>, si el área es menor que el área mínima representable, puede plantarse exagerar el área encerrada por la curva de nivel hasta que alcance el área mínima.</li>
