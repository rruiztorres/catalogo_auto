<template>
  <div>
    ...
    <div class="picture">
      <i>
        <img src="../img/0322p_otros_serv_inst_1.png" />
        <p>
          Ejemplo de captura para un observatorio espacial (Gran Telescópio de
          Canarias)
        </p>
      </i>
    </div>
    ...
    <p>
      No se han definido criterios de selección específicos para este objeto.
    </p>
