...
<p>Las islas en aguas interiores deben crear un recinto dentro de la lámina de agua sobre la que están situadas. Este recinto duplicará exactamente
	la geometría de la isla sin que existan espacios en blanco.</p>

<p>Criterio de selección</p>
<ul>
	<li>Marítimas: Deben capturarse todas, así como los islotes, escollos, farallones, bajos, etc. sea cual sea su superficie.</li>
	<li>Aguas interiores: Deben capturarse todas cuya superficie sea mayor de 100 m2. En el caso de las que pudieran estar presentes en el interior de los embalses, solo deben tener representación aquellas cuya altitud sea superior a la cota de la línea de máximo embalse.</li>
</ul>
